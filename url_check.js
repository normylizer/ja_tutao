...
function ajaxRequest() {
	...
	// Abbruchbedingung: Eingabe ist keine valide URL (mehr)
	if (isValidURL == false) {
		document.getElementById("remote_check_result").innerHTML = "Request abgebrochen. Es ist keine valide URL (mehr) eingetragen."
		return;
	}
